...
export async function nftokenMint(): Promise<boolean> {
  // ネットワーク設定
  ...
  try {
    ...
    if (error instanceof Error) {
      ...
      } else if (error.message.includes('temBAD_NFTOKEN_TRANSFER_FEE')) {
        console.error(
